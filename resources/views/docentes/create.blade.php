...
<body class="bg-violet-100 font-sans antialiased flex items-center justify-center min-h-screen">
    <div class="container mx-auto p-4 sm:p-8">
        <div class="bg-violet-50 rounded-lg shadow-xl p-6 sm:p-8 max-w-lg mx-auto">
            <h1 class="text-3xl font-bold text-violet-900 text-center mb-6">Agregar nuevo docente</h1>
            ...
            <form action="{{ route('docentes.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="nombre" id="nombre" class="w-full px-4 py-3 rounded-full bg-yellow-100 border-2 border-yellow-300 focus:outline-none focus:border-yellow-500 transition duration-300" required>
                </div>
                <div>
                    <label for="dni" class="block text-violet-800 font-semibold mb-2">DNI del docente</label>
                    <input type="text" name="dni" id="dni" class="w-full px-4 py-3 rounded-full bg-yellow-100 border-2 border-yellow-300 focus:outline-none focus:border-yellow-500 transition duration-300" required>
                </div>
                <div>
                    <label for="especialidad" class="block text-violet-800 font-semibold mb-2">Especialidad</label>
                    <input type="text" name="especialidad" id="especialidad" class="w-full px-4 py-3 rounded-full bg-yellow-100 border-2 border-yellow-300 focus:outline-none focus:border-yellow-500 transition duration-300" required>
                </div>
