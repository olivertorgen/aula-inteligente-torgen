...
<head>
    ...
    <title>Crear Aire Acondicionado</title>
...
<body class="bg-violet-100 font-sans antialiased flex items-center justify-center min-h-screen">
    <div class="container mx-auto p-4 sm:p-8">
        <div class="bg-violet-50 rounded-lg shadow-xl p-6 sm:p-8 max-w-lg mx-auto">
            <h1 class="text-3xl font-bold text-violet-900 text-center mb-6">Agregar nuevo aire acondicionado</h1>
            <p class="text-violet-700 text-center mb-8">Rellena el formulario para agregar un nuevo aire acondicionado a un aula.</p>
            ...
            <form action="{{ route('aires_acondicionados.store') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" id="modelo" name="modelo" value="{{ old('modelo') }}" class="w-full bg-yellow-200 text-violet-900 border border-yellow-300 rounded-lg py-3 px-4 focus:outline-none focus:ring-2 focus:ring-purple-500" required>
                </div>
