...
<body class="bg-violet-100 font-sans antialiased flex items-center justify-center min-h-screen">
    <div class="container mx-auto p-4 sm:p-8">
        <div class="bg-violet-50 rounded-lg shadow-xl p-6 sm:p-8 max-w-lg mx-auto">
            <h1 class="text-3xl font-bold text-violet-900 text-center mb-6">Crear nueva reserva</h1>
            ...
            <form action="{{ route('reservas.store') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="datetime-local" id="fecha_hora_inicio" name="fecha_hora_inicio" value="{{ old('fecha_hora_inicio') }}" class="w-full bg-yellow-200 text-violet-900 border border-yellow-300 rounded-lg py-3 px-4 focus:outline-none focus:ring-2 focus:ring-purple-500">
                </div>
                
                <div class="mb-6">
                    <label for="fecha_hora_fin" class="block text-violet-800 font-semibold mb-2">Fecha y hora de fin</label>
                    <input type="datetime-local" id="fecha_hora_fin" name="fecha_hora_fin" value="{{ old('fecha_hora_fin') }}" class="w-full bg-yellow-200 text-violet-900 border border-yellow-300 rounded-lg py-3 px-4 focus:outline-none focus:ring-2 focus:ring-purple-500">
                </div>
                ...
                <div class="mb-6">
                    ...
                    <input type="checkbox" id="necesita_proyector" name="necesita_proyector" value="1" {{ old('necesita_proyector') ? 'checked' : '' }} class="form-checkbox text-purple-500 h-5 w-5 rounded-full">
                </div>
